 ...
 */
	...
	/**
	 * 指定されたプリミティブ型配列のデータを {@link java.nio.FloatBuffer} へ変換して返します。
	 *
	 * @param array バッファデータ
	 * @return 変換されたバッファデータ
	 * @see {@link android.opengl.GLES20#glVertexAttribPointer(int, int, int, boolean, int, java.nio.Buffer)}
	 */
	 ...
	 * @throws android.opengl.GLException OpenGL API の操作に失敗した場合
	 */
	 ...
	 * @see {@link android.opengl.GLES20#GL_VERTEX_SHADER}
	 * @see {@link android.opengl.GLES20#GL_FRAGMENT_SHADER}
	 */
	 ...
	 * @throws android.opengl.GLException 直前の OpenGL API 操作でエラーが発生している場合
	 */
	...
	/**
	 * 指定された {@link android.graphics.Bitmap} 情報をテクスチャへ紐付けます。
	 *
	 * @param bitmap テクスチャへ紐付ける {@link android.graphics.Bitmap} 情報
	 * @return テクスチャ ID
	 */
	...
	/**
	 * 指定された {@link android.graphics.Bitmap} 情報をテクスチャへ紐付けます。<p>
	 ...
	 * @return テクスチャ ID
	 * @see {@link android.opengl.GLES20#GL_TEXTURE_MIN_FILTER}
	 * @see {@link android.opengl.GLES20#GL_TEXTURE_MAG_FILTER}
	 */
